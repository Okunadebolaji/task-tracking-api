        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskStatuses_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Module = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
                    Menu = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RejectedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CompanyId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Tasks_Users_RejectedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskRequirements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TaskRequirements_Requirements_RequirementId",
                        column: x => x.RequirementId,
                        principalTable: "Requirements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskRequirements_Tasks_TaskId",
                        column: x => x.TaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "TaskStatuses",
                columns: new[] { "Id", "CompanyId", "IsDefault", "IsFinal", "Name", "SortOrder" },
                values: new object[,]
                {
                    { 1, null, true, false, "Pending", 1 },
                    { 2, null, false, false, "In Progress", 2 },
                    { 3, null, false, true, "Completed", 3 },
                    { 4, null, false, true, "Rejected", 4 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskRequirements_RequirementId",
                table: "TaskRequirements",
                column: "RequirementId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskRequirements_TaskId",
                table: "TaskRequirements",
                column: "TaskId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tasks_RejectedByUserId",
                table: "Tasks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskStatuses_CompanyId",
                table: "TaskStatuses",
                column: "CompanyId");
